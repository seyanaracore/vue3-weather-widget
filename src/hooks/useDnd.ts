...
/**
 * Drag and drop hook
 * @param {dragTarget} dragTarget - html element which will move
 * @param {dragInitiator} dragInitiator - html element which will initiate the move
 */

const useDnd = (dragTarget: DragEl, dragInitiator: DragInitiatorEl = null) => {
